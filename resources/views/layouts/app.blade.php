...
<head>
    ...
    @vite(['resources/sass/app.scss', 'resources/js/app.js', 'resources/js/eliminar.js'])
</head>
<body>
    <div id="app">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="navbar-link" href="{{url('/inicio')}}"><img src="{{ asset('img/dr1ve.png')}}" height="70px"></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ url('/inicio')}}" id="a-incio">
                            ...
                            <li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/tienda') }}" id="a-tienda">
                            ...
                            @if (Route::has('login'))
                                @auth
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ url('/cart') }}" id="a-carrito">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                                                <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                                            </svg>
                                            Carrito
                                    ...
                                    <li class="nav-item">
                                        {{-- <a href="{{ url('/home') }}" class="nav-link" id="a-cierresesion"> --}}
                                        <a href="{{ url('/logout') }}" class="nav-link" id="a-cierresesion">
                                ...
                                @else
                                    <li class="nav-item">
                                        <a href="{{ route('login') }}" class="nav-link" id="a-iniciosesion">
                                    ...
                                    @if (Route::has('register'))
                                        <li class="nav-item">
                                            <a href="{{ route('register') }}" class="nav-link" id="a-registro">
                                ...
                                @endauth
                            @endif
                            @if(Auth::user() and (Auth::user()->usuario_administrador==1))
                                <li class="nav-item">
                                    <a href="{{route('panel.index')}}" class="nav-link" id="a-panel">
                            ...
                            @endif
                            <li class="nav-item">
                                <a href="{{url('/nosotros')}}" class="nav-link" id="a-nosotros">
                            ...
                            <li>
                            <li class="nav-item">
                                <a href="{{route('contacto.index')}}" class="nav-link" id="a-contacto">
